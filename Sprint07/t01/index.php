                ...
                <?php
                    ...
                    function send() {
                        $arr = [
                            ...
                            "strength" => $_POST["strength"] ? "has" : "doesn't have",
                            "speed" => $_POST["speed"] ? "has" : "doesn't have",
                            "intelligence" => $_POST["intelligence"] ? "has" : "doesn't have",
                            "teleportation" => $_POST["teleportation"] ? "has" : "doesn't have",
                            "immortal" => $_POST["immortal"] ? "has" : "doesn't have",
                            "another" => $_POST["another"] ? "another" : "doesn't have",
